...
A setup is explained in the [install demo](../../install/demo-setup.md) guide.
...
- Make sure you have gone through the [install demo](../../install/demo-setup.md) guide. We will extend the same setup for this integration.
...
```
Note that the same prometheus query is used as in the [install demo](../../install/demo-setup.md) guide for ElastiService and the namespace is the same as the namespace that the ElastiService is created in.
