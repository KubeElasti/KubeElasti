...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x128\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply\"\x00\x12@\n" +
	"\x0eSayHelloStream\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply\"\x000\x01B\x19Z\x17grpc-test-service/protob\x06proto3"
