...
* fix: switch proxy-mode services to serve mode when resolver deployment is deleted, preventing silent traffic loss by `@goodmorningsaksham` in [#297](https://github.com/KubeElasti/KubeElasti/pull/297). Fixes [#296](https://github.com/KubeElasti/KubeElasti/issues/296)
